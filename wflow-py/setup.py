...
setup(name='wflow',
      ...
      license = "GPL",
      scripts=['Scripts/wtools_py/StaticMaps.py','Scripts/wtools_py/CatchRiver.py','Scripts/wtools_py/CreateGrid.py',
               'Scripts/pcr2netcdf.py','Scripts/tss2xml.py','Scripts/wflow_subcatch.py',
