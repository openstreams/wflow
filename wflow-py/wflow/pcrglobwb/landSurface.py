...
class LandSurface(object):
    ...
    def __init__(self,iniItems,landmask,Dir,staticmaps,cloneMap,startTime,initialState=None):
        ...
        # cellArea (unit: m2)
        self.cellArea = vos.readPCRmapClone(iniItems.get("routingOptions","cellAreaMap"), #iniItems.routingOptions['cellAreaMap'], \
                                            self.cloneMap, self.tmpDir, self.inputDir)
        self.cellArea = pcr.ifthen(self.landmask, self.cellArea)
        
        # number of soil layers:
        self.numberOfSoilLayers = int(configget(iniItems,"landSurfaceOptions","numberOfUpperSoilLayers","2")) #int(iniItems.landSurfaceOptions['numberOfUpperSoilLayers'])
        ...
        self.debugWaterBalance = iniItems.get("landSurfaceOptions","debugWaterBalance") #iniItems.landSurfaceOptions['debugWaterBalance']
        ...
        if configget(iniItems,"landSurfaceOptions","includeIrrigation","False") == "True":
        ...
        if 'landCoverTypes' in configsection(iniItems,"landSurfaceOptions"): #iniItems.landSurfaceOptions.keys(): 
            self.coverTypes = iniItems.get("landSurfaceOptions","landCoverTypes").split(",") #iniItems.landSurfaceOptions['landCoverTypes'].split(",")
        ...
        if 'irrigationSurfaceWaterAbstractionFractionData' in configsection(iniItems,"landSurfaceOptions") and\
           'irrigationSurfaceWaterAbstractionFractionDataQuality' in configsection(iniItems,"landSurfaceOptions"):
            if configget(iniItems,"landSurfaceOptions","irrigationSurfaceWaterAbstractionFractionData","None") not in ["None", "False"] or\
               configget(iniItems,"landSurfaceOptions","irrigationSurfaceWaterAbstractionFractionDataQuality", "None") not in ["None", "False"]: 
               #iniItems.landSurfaceOptions['irrigationSurfaceWaterAbstractionFractionDataQuality'] not in ["None", "False"]:
                ...
                self.swAbstractionFractionData = pcr.cover(\
                                                 ...
                                                 vos.readPCRmapClone(configget(iniItems,"landSurfaceOptions","irrigationSurfaceWaterAbstractionFractionData","None"),\
                ...
                self.swAbstractionFractionDataQuality = \
                                                 ...
                                                 vos.readPCRmapClone(configget(iniItems,"landSurfaceOptions","irrigationSurfaceWaterAbstractionFractionDataQuality","None"),\
                                                                     self.cloneMap,self.tmpDir,self.inputDir), 0.0)
        ...
        if 'maximumNonIrrigationSurfaceWaterAbstractionFractionData' in configsection(iniItems,"landSurfaceOptions"):
            if configget(iniItems,"landSurfaceOptions","maximumNonIrrigationSurfaceWaterAbstractionFractionData","None") != "None" or\
               configget(iniItems,"landSurfaceOptions","maximumNonIrrigationSurfaceWaterAbstractionFractionData","False") != "False":
                ...
                self.maximumNonIrrigationSurfaceWaterAbstractionFractionData = pcr.min(1.0,\
                                                                               ...
                                                                               vos.readPCRmapClone(configget(iniItems,"landSurfaceOptions","maximumNonIrrigationSurfaceWaterAbstractionFractionData","None"),\
        ...
        self.treshold_to_maximize_irrigation_surface_water = \
         vos.readPCRmapClone(configget(iniItems,"landSurfaceOptions","treshold_to_maximize_irrigation_surface_water","1.0"),\
        ...
        self.treshold_to_minimize_fossil_groundwater_irrigation = \
         vos.readPCRmapClone(configget(iniItems,"landSurfaceOptions","treshold_to_minimize_fossil_groundwater_irrigation","1.0"),\
        ...
        self.soil_topo_parameters['default'] = parSoilAndTopo.SoilAndTopoParameters(iniItems,self.landmask,self.inputDir,self.cloneMap,self.tmpDir)
        ...
        for coverType in self.coverTypes: 
            self.landCoverObj[coverType] = lc.LandCover(iniItems,\
                                                        ...
                                                        self.cloneMap, self.inputDir, self.tmpDir, self.usingAllocSegments)
        ...
        if "noLandCoverFractionCorrection" in configsection(iniItems,"landSurfaceOptions"): #iniItems.landSurfaceOptions.keys():
            #if iniItems.landSurfaceOptions["noLandCoverFractionCorrection"] == "True": self.noLandCoverFractionCorrection = True:
            if configget(iniItems,"landSurfaceOptions","noLandCoverFractionCorrection","False") == "True": self.noLandCoverFractionCorrection = True
        ...
        if 'annualChangesInLandCoverParameters' in configsection(iniItems,"landSurfaceOptions"):
    ...
    def initiate_old_style_land_surface_reporting(self,iniItems):
        ...
        self.report = True
        try:
            self.outDailyTotNC = iniItems.get("landSurfaceOptions","outDailyTotNC").split(",")
            self.outMonthTotNC = iniItems.get("landSurfaceOptions","outMonthTotNC").split(",")
            self.outMonthAvgNC = iniItems.get("landSurfaceOptions","outMonthAvgNC").split(",")
            self.outMonthEndNC = iniItems.get("landSurfaceOptions","outMonthEndNC").split(",")
            self.outAnnuaTotNC = iniItems.get("landSurfaceOptions","outAnnuaTotNC").split(",")
            self.outAnnuaAvgNC = iniItems.get("landSurfaceOptions","outAnnuaAvgNC").split(",")
            self.outAnnuaEndNC = iniItems.get("landSurfaceOptions","outAnnuaEndNC").split(",")
        except:
            self.report = False
        if self.report == True:
    ...
    def getInitialConditions(self, iniItems, iniConditions = None):
        ...
        starting_year = self.startTime.timetuple().tm_year#int(iniItems.get("run","starttime")[0:4])
    ...
    def waterDemandOptions(self,iniItems):
        ...
        if configget(iniItems,"landSurfaceOptions","includeDomesticWaterDemand","False")  == "True":
        ...
        if self.domesticWaterDemandOption:
            self.domesticWaterDemandFile = vos.getFullPath(\
             configget(iniItems,"landSurfaceOptions","domesticWaterDemandFile","None"),self.inputDir,False)

        # industry water demand (unit: m/day)
        #
        self.industryWaterDemandOption = False
        if configget(iniItems,"landSurfaceOptions","includeIndustryWaterDemand","False")  == "True":
        ...
        if self.industryWaterDemandOption:
            self.industryWaterDemandFile = vos.getFullPath(\
             configget(iniItems,"landSurfaceOptions","industryWaterDemandFile","None"),self.inputDir,False)

        # livestock water demand (unit: m/day)
        self.livestockWaterDemandOption = False
        if configget(iniItems,"landSurfaceOptions","includeLivestockWaterDemand","False")  == "True":
        ...
        if self.livestockWaterDemandOption:
            self.livestockWaterDemandFile = vos.getFullPath(\
             configget(iniItems,"landSurfaceOptions","livestockWaterDemandFile","None"),self.inputDir,False)
        
        # historical irrigation area (unit: hectar)
        self.dynamicIrrigationArea = False
        if configget(iniItems,"landSurfaceOptions","historicalIrrigationArea","None") != "None":
        ...
        if self.dynamicIrrigationArea:
            self.dynamicIrrigationAreaFile = vos.getFullPath(\
               configget(iniItems,"landSurfaceOptions","historicalIrrigationArea","None"),self.inputDir,False)
        ...
        if configget(iniItems,"landSurfaceOptions","desalinationWater","False") not in ["None", "False"]:
            logger.info("Monthly desalination water is included.")
            self.includeDesalination = True
            self.desalinationWaterFile = vos.getFullPath(configget(iniItems,"landSurfaceOptions","desalinationWater","None"), self.inputDir)
        else:    
        ...
        if configget(iniItems,"landSurfaceOptions","allocationSegmentsForGroundSurfaceWater","None")  != "None":
    ...
    def calculateCapRiseFrac(self,groundwater,routing,currTimeStep):
        ...
        if groundwater.useMODFLOW == True:
            ...
            if currTimeStep.day == 1 and currTimeStep.timeStepPCR > 1: 
                ...
                directory = iniItems.get("globalOptions","outputDir") + "/modflow/transient/maps/"
    ...
    def update(self,meteo,groundwater,routing,currTimeStep,wflow_logger):
        ...
        for coverType in self.coverTypes:
            ...
            self.landCoverObj[coverType].updateLC(meteo,groundwater,routing,\
                                                  ...
                                                  self.groundwater_pumping_region_ids,self.regionalAnnualGroundwaterAbstractionLimit,wflow_logger)
