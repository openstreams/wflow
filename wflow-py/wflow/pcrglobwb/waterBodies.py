...
class WaterBodies(object):
    ...
    def __init__(self,iniItems,landmask,Dir,cloneMap,tmpDir):
        ...
        if "onlyNaturalWaterBodies" in iniItems._sections['routingOptions'] and configget(iniItems,"routingOptions","onlyNaturalWaterBodies","False") == "True":
        ...
        if configget(iniItems,"routingOptions","waterBodyInputNC","None") == str(None):
