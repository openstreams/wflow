    ...
    if os.path.exists(inxml):
        ...
        with open(outxml, 'w') as fo:
            for aline in lines:
                ...
                if pos >= 0:
                    fo.write("<dateTime date=\"" + datestr + "\" time=\"" + timestr + "\"/>\n")
                else:
                    fo.write(aline)
...
def tss_topixml(tssfile,xmlfile,locationname,parametername,Sdate,timestep):
    ...
    with open(xmlfile, 'w') as fo:
        fo.write("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n")
        fo.write("<TimeSeries xmlns=\"http://www.wldelft.nl/fews/PI\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.wldelft.nl/fews/PI http://fews.wldelft.nl/schemas/version1.0/pi-schemas/pi_timeseries.xsd\" version=\"1.2\">\n")
        ...
        for col in tss.transpose():
            ...
            for pt in col:
                if xcount > 1:
                    ...
                    fo.write("<event date=\"" + Ndatestr + "\" time=\"" + Ntimestr + "\" value=\"" + str(pt) + "\" />\n")
...
def mapstackxml(mapstackxml,mapstackname,locationname,parametername,Sdate,Edate,timestepsecs):
    ...
    with open(mapstackxml, 'w') as fo:
        fo.write("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n")
        fo.write("<MapStacks xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://www.wldelft.nl/fews/PI\" xsi:schemaLocation=\"http://www.wldelft.nl/fews/PI http://fews.wldelft.nl/schemas/version1.0/pi-schemas/pi_mapstacks.xsd\" version=\"1.2\">\n")
